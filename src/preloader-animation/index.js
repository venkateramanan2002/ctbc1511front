...
export const openMenu = () => {
  ...
  menuTimeline
    .to("body", { duration: 0.1, css: { overflowY: "hidden" }, ease: "power3.out" })
...
export const mobileLanding = () => {
  window.innerWidth < 763 && tl.from(".landing__main2", { duration: 1, delay: 0, opacity: 0, y: 80, ease: "expo.easeOut" });
};
